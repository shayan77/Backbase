//
//  BackbaseTableViewDataSource.swift
//  Backbase
//
...
/*
 ...
 This is BackbaseTableViewDataSource responsible for data source of simple tableViews.
 
 You can easily add new datas to array by confirming your tableViewCell to BackbaseTableViewCell.
...
extension BackbaseTableViewDelegate {
    func tableView(cellForRowAt: IndexPath, cell: UITableViewCell) { }
    func tableView(willDisplay cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didEndDisplaying cellIndexPath: IndexPath, cell: UITableViewCell) { }
    func tableView(didSelectRowAt index: IndexPath) { }
...
public class BackbaseTableViewDataSource<T: BackbaseTableViewCell>: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    weak var delegate: BackbaseTableViewDelegate?
    
    public init(cellHeight: CGFloat?, items: [T.CellViewModel] = [], tableView: UITableView, delegate: BackbaseTableViewDelegate, animationType: CellAnimationType = .none) {
